    ...
    operations = [
            ...
            fields=[
                ('id',
                    models.AutoField(verbose_name='ID', serialize=False,
                                     auto_created=True, primary_key=True)),
                ('preparation',
                    models.ForeignKey(to='whats_fresh_api.Preparation')),
                ('product',
                    models.ForeignKey(to='whats_fresh_api.Product')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('images',
                    models.ManyToManyField(to='whats_fresh_api.Image',
        ...
        migrations.AddField(
            model_name='vendor',
            name='story',
            field=models.ForeignKey(blank=True, to='whats_fresh_api.Story',
                                    null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='story',
            name='videos',
            field=models.ManyToManyField(to='whats_fresh_api.Video',
                                         null=True, blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
